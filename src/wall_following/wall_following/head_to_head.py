...
class Agent(Node):
    def __init__(self):
        ...
        # head-to-head racing
        self.drive_pub_ego = self.create_publisher(AckermannDriveStamped, 'drive', 1)
        self.scan_sub_ego = self.create_subscription(LaserScan, 'scan', self.scan_callback_ego, 1)
        self.drive_pub_opp = self.create_publisher(AckermannDriveStamped, 'opp_drive', 1)
        self.scan_sub_opp = self.create_subscription(LaserScan, 'opp_scan', self.scan_callback_opp, 1)
